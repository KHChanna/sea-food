...
<div class="content-wrapper">
    <div class="container h-100" style="background-color: #fff">
        ...
        <div class="row mb-1">
            ...
            <div class="col-sm-2">: {{$purchase->invoice_number}}</div>
        ...
        <div class="row mb-1">
            ...
            <div class="col-sm-2">: {{$purchase->code}}</div>
            <div class="col-sm-2">Total Paid</div>
            <div class="col-sm-2">: {{$purchase->paid_amount}} $</div>
        </div>

        <div class="row mb-1">
            <div class="col-sm-2">Date</div>
            <div class="col-sm-2">: {{$purchase->created_at}}</div>
            {{-- <div class="col-sm-2">Payment Type</div> --}}
            {{-- <div class="col-sm-2">: {{Payment($purchase->payment_type)}}</div> --}}
